...
if __name__ == '__main__':
  ...
  sp.load('data/spiece.model')

  print_(u'I was born in 2000, and this is falsé.')
  print_(u'ORIG', sp.EncodeAsPieces(u'I was born in 2000, and this is falsé.'))
  ...
  print_('ORIG', sp.EncodeAsPieces(prepro_func('I was born in 2000, and this is falsé.')))
  ...
  print_('ORIG', sp.EncodeAsPieces('I was born in 2000, and this is falsé.'))
  ...
  print_('ORIG', sp.EncodeAsPieces('I was born in 92000, and this is falsé.'))
